declare module "csstype" {
  ...
  declare type BorderRadiusProperty<TLength> = All | LengthPercentage<TLength>;
  ...
  declare type BoxShadowProperty = All | "none" | string;
  ...
  declare type DisplayProperty = All | DisplayOutside | DisplayInside | DisplayInternal | DisplayBox | DisplayLegacy | string;
  ...
  declare type FontFeatureSettingsProperty = All | FeatureTagValue | "normal";
  ...
  declare type FontVariantProperty = All | "none" | "normal" | string;

  declare type FontVariantAlternatesProperty = All | "normal" | string;
  ...
  declare type GridAreaProperty = All | GridLine;

  declare type GridAutoFlowProperty = All | "column" | "dense" | "row" | string;

  declare type GridColumnProperty = All | GridLine;
  ...
  declare type GridRowProperty = All | GridLine;
  ...
  declare type GridTemplateColumnsProperty = All | "none" | string;

  declare type GridTemplateRowsProperty = All | "none" | string;
  ...
  declare type ImageOrientationProperty = All | "from-image" | string;
  ...
  declare type InitialLetterProperty = All | "normal" | string;
  ...
  declare type OffsetAnchorProperty = All | "auto" | string;
  ...
  declare type OffsetPositionProperty = All | "auto" | string;
  ...
  declare type ScrollSnapCoordinateProperty = All | "none" | string;
  ...
  declare type TextCombineUprightProperty = All | "all" | "none" | string;
  ...
  declare type TextShadowProperty = All | "none" | string;
  ...
  declare type SingleTimingFunction = StepTimingFunction | "linear" | string;
  ...
  declare type FeatureTagValue = "off" | "on" | string | number;
  ...
  declare type GridLine = "auto" | string;

  declare type MaskLayer<TLength> = MaskReference | BgSize<TLength> | RepeatStyle | GeometryBox | CompositingOperator | MaskingMode | "no-clip" | string;
  ...
  declare type MaskPosition<TLength> = LengthPercentage<TLength> | "bottom" | "center" | "left" | "right" | "top";
}
